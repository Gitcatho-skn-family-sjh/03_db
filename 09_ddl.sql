...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, null, 'pass03', '이순신', '남', '010-777-7777', 'lee222@gmail.com');

# NOT NULL 제약조건 해결
INSERT INTO user_unique
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(3, 'user01', 'pass03', '이순신', '남', '010-8888-8888', 'lee222@gmail.com');
...
(user_no, user_id, user_pwd, user_name, gender, phone, email)
VALUES
(null, 'user03', 'pass03', '이순신', '남', '010-1234-5678', 'hong123@gmail.com');
...
# [23000][1062] Duplicate entry '3-100-2026-06-12 11:32:03' for key 'order_composite_pk.PRIMARY'
...
CREATE TABLE IF NOT EXISTS user_foreignkey1 (
    ...
    phone VARCHAR(255) NOT NULL,
    email VARCHAR(255),
    grade_code INT , # 10,20,30,NULL 삽입가능
