/* SQL(Structured Query Language)
   - 구조화된 질의 언어
   - RDBMS에서 저장된 데이터를 관리, 조작하거나 DB구조를 제어할 때 사용하는 언어
## SQL 종류
...
select menu_name as 메뉴명,
       menu_price as "메뉴 가격", #띄어쓰기된 컬럼 묶기
...
from
    tbl_category
where
    # ref_category_code 컬럼 안에 'null'이라는 값이 있으면 True
    # -> null은 값(data)가 아님.
    # 컬럼이 비었음을 나타내는 기호
...
# limit start, n : start 인덱스 부터 n행 만큼 조회
